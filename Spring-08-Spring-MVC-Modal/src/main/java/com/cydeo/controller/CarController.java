...
public class CarController {
    @RequestMapping("/info") // loclhost:808/car/info?make=honda
 public String carInfo(@RequestParam String make ,@RequestParam Integer year, Model model){
    ...
    @RequestMapping("/info2") // loclhost:808/car/info?make=honda
    public String carInfo2(@RequestParam (value="make",required = false,defaultValue = "CHR")String make , Model model){
